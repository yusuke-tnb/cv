...
- コンセプチュアルスキルを活かし、全体目標から具体的行動に落とし込み、主体的に行動します。
- キャッチアップの速度と精度に自身があり、未経験の内容を積極的に携わっていきたいと考えておりあます。

## 主な業務経歴

### ベトナムに展開する医療系プラットフォームサービスのアーキテクチャ設計〜開発【Nuxt / Node / AWS】(2020年、WELLNESONE JAPAN)
...
### 保険代理店向けのマッチングサービスの開発【Nuxt / Firebase】(2019年、フリーランス)
...
### 建築系の資材受発注システムの改修【Nuxt / Node】(2019年、フリーランス)
...
### 経理システムの改修【Laravel】(2019年、フリーランス)
...
### IoT機器と連携させる画像共有サービスの企画〜開発【Nuxt / Laravel】(2018年、コニカミノルタ株式会社)
...
### 医用機器のUI部分のチームリーダとして要件定義〜開発【WPF】(2018年、コニカミノルタ株式会社)
